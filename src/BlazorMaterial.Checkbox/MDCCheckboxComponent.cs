...
{
    public class MDCCheckboxComponent : BlazorMaterialComponent
    {
        private const string ADD_RIPPLE_FUNCTION = "mdc.ripple.MDCRipple.attachTo";
        private static readonly ClassBuilder<MDCCheckboxComponent> _classNameBuilder;
        ...
        static MDCCheckboxComponent()
        {
            _classNameBuilder = new ClassBuilder<MDCCheckboxComponent>("mdc", "button")
